...
from yolo.test import test  # import test.py to get mAP after each epoch
...
from eff.transforms import get_transforms

from eff.model import Classifier
from eff.train import train_fn, test_fn
from eff.dataset import CustomDataset

#(import train code module)
from yolo.train import train
from crop_make_folder import crop_merge_img, crop_main
from eff.training import seed_torch,run
...
def efficientnet_v3():
    ...
    parser.add_argument('--train_path', type=str, default="eff/train_covid_croped.csv", metavar='P',
                        help='train label path')
    parser.add_argument('--test_path', type=str, default="eff/test_covid_croped.csv", metavar='P',
    ...
    parser.add_argument('--n_fold', type=int, default=1, metavar='N',
